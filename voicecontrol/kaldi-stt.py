...
# Kopie von kaldi_decode_live.py
# Erkennt deutsche Sprache und gibt sowohl das aufgenommene Audio als auch den Text aus
# Das Audio kann benutzt werden, um per alsamixer die Mikrofonempfindlichkeit einzustellen
...
player = PulsePlayer (name="Player halt")
